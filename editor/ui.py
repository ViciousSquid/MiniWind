...
class Ui_MainWindow(object):
    ...
    def create_menu_bar(self, MainWindow):
        ...
        MainWindow.quest_editor_action = QAction("Quest Editor", MainWindow)
        MainWindow.quest_editor_action.setToolTip(
            "Open the MiniWind Quest Editor (it has its own button to launch "
            "the guided Quest Wizard)"
        )
        MainWindow.quest_editor_action.triggered.connect(MainWindow.open_quest_editor)
        MainWindow.tools_menu.addAction(MainWindow.quest_editor_action)
